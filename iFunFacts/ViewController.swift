...
class ViewController: UIViewController {
    ...
    @IBAction func funButtonClicked(_ sender: UIButton) {
        ...
        funText.textColor = UIColor.white
        funText.text = getFunFact()
    }
    ...
    func backgroundColor() -> UIColor{
        let randomNumber = Int(arc4random_uniform(UInt32(myBackgroudColor.count)))
        return myBackgroudColor[randomNumber]
    }
    
    let myBackgroudColor: [UIColor] = [
        UIColor.init(red: 0.91, green: 0.23, blue: 0.15, alpha: 1.00),
        UIColor.init(red: 0.86, green: 0.11, blue: 0.34, alpha: 1.00),
        UIColor.init(red: 0.55, green: 0.15, blue: 0.67, alpha: 1.00),
        UIColor.init(red: 0.36, green: 0.20, blue: 0.70, alpha: 1.00),
        UIColor.init(red: 0.24, green: 0.28, blue: 0.69, alpha: 1.00),
        UIColor.init(red: 0.15, green: 0.55, blue: 0.49, alpha: 1.00),
        UIColor.init(red: 0.35, green: 0.45, blue: 0.51, alpha: 1.00)
    ]
